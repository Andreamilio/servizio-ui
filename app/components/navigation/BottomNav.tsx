...
export function BottomNav({ role }: BottomNavProps) {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-50 lg:hidden bg-[var(--bg-card)] border-t border-[var(--border-light)] shadow-lg" style={{ paddingBottom: 'env(safe-area-inset-bottom, 0)' }}>
