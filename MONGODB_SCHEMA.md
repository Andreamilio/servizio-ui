...
```javascript
"guest_access_ok" | "guest_access_ko" | "cleaner_access_ok" |
"pin_created" | "pin_revoked" | "cleaning_done" | "problem_reported" |
"door_opened" | "door_closed" | "gate_opened" | "wan_switched" |
"vpn_toggled" | "stay_created" | "stay_deleted" | "stay_guests_updated"
```
...
**DeviceType enum:**
```javascript
"smart_lock" | "relay_gate" | "smoke_sensor" | "thermostat" |
"alarm_sensors" | "lights" | "ring_cam" | "scenes" | "ups"
```
...
**Note:**
- Le relazioni sono implementate tramite `clientId`, `aptId`, `stayId`, `userId` come foreign keys
...
- Considerare paginazione per collezioni grandi (`AccessEvents`, `Pins`)
